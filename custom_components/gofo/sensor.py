"""Sensor platform for the GOFO Express parcel tracker integration."""
...
async def async_setup_entry(
    hass: HomeAssistant,
    entry: GOFOExpressConfigEntry,
    async_add_entities: AddEntitiesCallback,
) -> None:
    """Set up GOFO Express sensor entities from a config entry."""
...
class GOFOExpressIncomingParcelsSensor(
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        if new_barcodes:
            self._async_add_entities(
                GOFOExpressParcelSensor(self.coordinator, self._entry, barcode)
...
class GOFOExpressParcelSensor(CoordinatorEntity[GOFOExpressCoordinator], SensorEntity):
    """Per-parcel sensor reporting the status of one tracked GOFO Express parcel."""
    ...
    def __init__(
        self, coordinator: GOFOExpressCoordinator, entry: ConfigEntry, barcode: str
    ) -> None:
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._entry = entry
...
class GOFOExpressNextDeliverySensor(
    CoordinatorEntity[GOFOExpressCoordinator], SensorEntity
):
...
class GOFOExpressDeliveredParcelsSensor(
    ...
    """Recently delivered tracked GOFO Express parcels."""
...
class GOFOExpressLastUpdateSensor(
    CoordinatorEntity[GOFOExpressCoordinator], SensorEntity
):
    """Diagnostic sensor reporting when GOFO Express was last polled successfully."""
